...
public class AsyncTaskOperation {
	...
	public AsyncTaskOperation(AsyncTask task, TaskType asyncExecutor, TaskType finallyExecutor) {
	...
	public AsyncTaskOperation(AsyncTask task, TaskType asyncExecutor, long asyncId, TaskType finallyExecutor, long finallyId) {
