...
import com.ubird.astar.core.exception.AStarPositionException;

import cn.game.core.map.Grid;

public class AStarNode extends Grid implements Comparable<AStarNode> {
...
//	}
	...
	public int distinctG(AStarNode father) {
		...
		if(offsetX==0 && offsety==-1)
			...
			throw new AStarPositionException("Unvalid relation between current node("+this+") and fater node("+father+")");
