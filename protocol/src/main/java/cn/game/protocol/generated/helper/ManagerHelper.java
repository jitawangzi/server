...
import cn.game.protocol.generated.manager.AlchemyManager;
...
import cn.game.protocol.generated.manager.HeroEquipManager;
...
import cn.game.protocol.generated.manager.ConsumeIncrementalManager;
...
public class ManagerHelper {
	...
	public static void init() {
		...
		GemManager.instance().load();
		HeroEquipManager.instance().load();
		...
		ConsumeIncrementalManager.instance().load();
		...
		HeroSourceManager.instance().load();
		...
		HeroQualityManager.instance().load();
