 ...
 */
 public class HeroSkillConfig {
	...
	/** 技能属性标签  1-基础伤害  2-风伤害  3-火伤害  4-雷伤害  5-电伤害  6-冰伤害  7-毒伤害  8-额外三界伤害  9-额外天庭伤害 10-额外地府伤害 11-治疗 12-属性 13-buff */
	public final int AttributeMark;		
	/** 状态类型 0-本身无效过只是为了挂接附加技能组 1-范围 2-子弹 3-瞬发 4-效果(buff/debuff) */
	...
	public HeroSkillConfig (Element element) throws Exception {
		...
		AttributeMark = Integer.parseInt(element.getAttribute("AttributeMark") == null || element.getAttribute("AttributeMark").length() == 0 ? "0"
			: element.getAttribute("AttributeMark")); // 技能属性标签  1-基础伤害  2-风伤害  3-火伤害  4-雷伤害  5-电伤害  6-冰伤害  7-毒伤害  8-额外三界伤害  9-额外天庭伤害 10-额外地府伤害 11-治疗 12-属性 13-buff
		StatusType = Integer.parseInt(element.getAttribute("StatusType") == null || element.getAttribute("StatusType").length() == 0 ? "0"
			: element.getAttribute("StatusType")); // 状态类型 0-本身无效过只是为了挂接附加技能组 1-范围 2-子弹 3-瞬发 4-效果(buff/debuff)
