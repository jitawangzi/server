 ...
 */
 public class Test1Config {
	...
	public Test1Config (Element element) throws Exception {
		...
		notread = Integer.parseInt(element.getAttribute("notread") == null || element.getAttribute("notread").length() == 0 ? "0"
			: element.getAttribute("notread")); // 不读的数据
	}
