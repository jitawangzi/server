...
public enum EventTypeEnum {
	/** 初始化/创建新玩家，只会有一次这个事件，这个事件先于PLAYER_CREATE 发生
	 * 如果某些初始化操作的优先级高，可以使用这个事件 */
	PLAYER_INIT("创建新玩家"),
    /** 创建新玩家，只会有一次这个事件 */
    PLAYER_CREATE("创建新玩家"),
    ...
    FuncOpen("功能开启 "),
    /** 新添加了某种资源 */
    ResourceAdd("新添加了某种资源"),
    /** 某种资源被移除 */
    ResourceRemove("某种资源被移除"),
    WatchAds("看了一次广告"),
    CultivatesImmortals("提升天道修为等级"),
    ...
    ChapterFirstWin("第一次通关主线 "),
    /** 装备部位强化 参数：pos，level*/
    EquipPartStrength("装备部位强化"),
    /** 宝石穿戴 参数： 配置表id */
    GemWear("宝石穿戴"),
    /** 大圣擂台积分增加. 参数 1 增加前的旧积分 2 增加的积分 */
    DaShengPointsAdd("大圣擂台积分增加"),
    /** 大王来巡山通关 */
    XunShanComplete("大王来巡山通关"),
    //成就相关
    /** 开启战斗 :  BattleConfig, id，子id*/
    BattleStart("开启战斗"),
    /** 开启战斗 : HCBattle id，关卡id*/
    HCBattleStart("开启战斗"),
    ParticipatePVPStart("开始大道争锋PVP战斗"),
    /** 角色更换技能 */
    SwitchSkills("角色更换技能"),
    /** 探索后获得资源 */
    ExploreGetResources("探索后获得资源"),
    /** 使用道具 */
    ItemUse("使用道具"),
    /** 收集图鉴 */
    CollectAtlas("收集图鉴"),
    ...
    BuffChange("buff改变"),
    /** 某游戏事件完成 参数： 事件id */
    GameEventFinish("某游戏事件完成"),
    vipExpChange("VIP 经验变动"),
    vipLevelChange("VIP 等级变动"),
    QuestFinish("任务完成"),
    QiangYuan("强援修炼"),
    FairyFriendsTravel("仙友寻缘"),
    FairyFriendsGift("仙友赠礼"),
    HeroRecruit("英雄招募"),
    /** 更新阵容 参数： 玩法类型 */
    LineupUpdate("更新阵容"),
    /** 灵山问禅快速跳到某层 参数： 层数 */
    LingShanSkipFloor("灵山问禅快速跳到某层"),
    /** 公会砍价 */
    GuildBargain("公会砍价"),
