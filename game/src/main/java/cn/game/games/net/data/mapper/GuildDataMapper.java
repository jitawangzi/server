...
public interface GuildDataMapper {
	 ...
	 * @mbg.generated
	 */
	int updateByPrimaryKey(GuildData row);

	/**
	 * @mbg.generated
	 */
	List<GuildData> selectAll();

	/**
	 * @mbg.generated
	 */
	List<GuildData> getBatchOffset(@Param("offset") int offset, @Param("limit") int limit);

	/**
	 * @mbg.generated
	 */
	List<GuildData> getBatchCursor(@Param("lastId") long lastId, @Param("limit") int limit);
	 ...
	 * @mbg.generated
	 */
	int insertBatch(List<GuildData> records);

	/**
	 * @mbg.generated
	 */
	int deleteBatch(List<GuildData> records);

	/**
	 * @mbg.generated
	 */
	int updateBatch(@Param("recordList") List<GuildData> recordList);
