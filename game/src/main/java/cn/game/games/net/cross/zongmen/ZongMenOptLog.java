...
public class ZongMenOptLog implements ZongMenConstants.ZongMenEventHandler {
	...
	public ZongMenConstants.ZongMenEvenType[] getRegisterEvent() {
		return new ZongMenConstants.ZongMenEvenType[] { ZongMenConstants.ZongMenEvenType.JOIN_ZONG_MEN,
				ZongMenConstants.ZongMenEvenType.ZONG_MEN_POSITION_CHANGE, ZongMenConstants.ZongMenEvenType.CHANGE_ZONG_MEN_NAME,
				ZongMenConstants.ZongMenEvenType.QUIT_ZONG_MEN, ZongMenConstants.ZongMenEvenType.CHANGE_ZONG_MEN_DECLARATION,
				ZongMenConstants.ZongMenEvenType.ZONG_MEN_KICK_MEMBER, ZongMenConstants.ZongMenEvenType.CHANGE_ZONG_MEN_NOTICE, };
	}
	...
	private void addLog(ZongMen info, int type, String... params) {
	...
	public static class OptLogData {
		...
		public ZongMenMsg.ZongMenLogProto toProto() {
			return ZongMenMsg.ZongMenLogProto.newBuilder()
					.setType(optType)
