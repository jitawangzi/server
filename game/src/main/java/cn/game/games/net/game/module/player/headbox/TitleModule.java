 ...
 * 头像框模块
 */
public class TitleModule extends AbstractItemOnlyOneModule<Title> {
	...
	@Override
	public void setInstanceExt(Title item) {
...
//		}
	...
	public GoodsTypeEnum getGoodsTypeEnum() {
		return GoodsTypeEnum.Title;
	}

	@Override
	public void buildPlayerAllInfo(Builder builder) {
		idItems.forEach((k, v) -> {
			builder.putTitleMap(k, v.getExpiredTime());
		});
