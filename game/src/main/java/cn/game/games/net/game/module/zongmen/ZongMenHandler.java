...
import cn.game.protocol.protobuf.ZongMenCrossMsg.ZongMenMsgPush_41000045;
...
public class ZongMenHandler extends GameBaseHandler {
    ...
    public static Future<ZongMenCallbackMsg> sendMsgToZongMenServer(long zongMenId, Player player, Message req, String... params) {
        // 封装宗门请求
        ZongMenMsgPush_41000045.Builder serverReq = ZongMenMsgPush_41000045.newBuilder();
        // 设置请求参数
        // 宗门ids
    ...
    private void bargain(NetClient client, Object o) {
        ...
        zongmenModule.setBargainCount(bargainCount + 1);
        client.sendProtocol(res.build());
    ...
    private void buyBargain(NetClient client, Object o) {
        ...
        ZongMenModule zongmenModule = player.getZongmenModule(); 
        zongmenModule.setBargainBuy(true);
        client.sendProtocol(res.build());
    }
    ...
    private void getZongMenInfo(NetClient client, Object o) {
        ...
        ZongmenServiceInterface zongmenProxy = ServerHelper.getZongmenProxy(player.getGuildId()); 
        ZongMenServiceInfo zongMenAllInfoForMember = zongmenProxy.getZongMenAllInfoForMember(player.getGuildId()); 
        ZongMenAllInfo allInfo = ZongMenHelper.buildAllInfo(zongMenAllInfoForMember, player.getPlayerId()); 
        res.setInfo(allInfo); 
        client.sendProtocol(res.build());
    }
    ...
    private void createZongMen(NetClient client, Object o) {
        ...
        CompletableFuture.allOf(checkComplatableList.toArray(new CompletableFuture[0])).thenAcceptAsync(result -> {
    		...
    		ZongmenServiceInterface zongmenProxy = ServerHelper.getZongmenProxy(0); 
