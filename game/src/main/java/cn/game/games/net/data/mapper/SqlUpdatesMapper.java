...
public interface SqlUpdatesMapper {
	 ...
	 * @mbg.generated
	 */
	List<SqlUpdates> getBatchOffset(@Param("offset") int offset, @Param("limit") int limit);

	/**
	 * @mbg.generated
	 */
	List<SqlUpdates> getBatchCursor(@Param("lastId") Integer lastId, @Param("limit") int limit);
