 ...
 * @author SYQ
 */
public class GuildBargain implements GuildConstants.GuildEventHandler {
	...
	private void refreshBargain() {
		...
		List<GuildBargainConfig> levelList = GuildBargainManager.instance().getLevelList(guild.getLv()); 
	...
	public GuildConstants.GuildEvenType[] getRegisterEvent() {
		return new GuildConstants.GuildEvenType[] { GuildConstants.GuildEvenType.CROSS_DAY };
	}
	...
	public GuildMsg.GuildBargainSharedInfo toProto() {
		return GuildMsg.GuildBargainSharedInfo.newBuilder()
