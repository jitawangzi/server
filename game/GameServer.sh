...
#main class
MAIN_CLASS="net.game.GameServer "

#application arguments
APP_ARGS="res/applicationContext-gatewayserver.xml res/applicationContext-dataserver.xml res/applicationContext-gameserver.xml"
