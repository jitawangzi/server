...
@Component
public class RankListRequest_35000001Test extends ServerTest<cn.game.protocol.protobuf.RankMsg.RankListRequest_35000001, cn.game.protocol.protobuf.RankMsg.RankListResponse_35000002> {

	@Override
	public cn.game.protocol.protobuf.RankMsg.RankListRequest_35000001 buildDebugRequest(Client client) {
...
//		builder.setType(rankType.ID);
	...
	@Override
	public cn.game.protocol.protobuf.RankMsg.RankListRequest_35000001 tryBuildSimulationRequest(Client client) {
		cn.game.protocol.protobuf.RankMsg.RankListRequest_35000001.Builder builder = cn.game.protocol.protobuf.RankMsg.RankListRequest_35000001
				.newBuilder();
		// 随机一个排行榜
		RankType[] values = RankType.values();
...
//		builder.setType(RankType.Battle.ID);
	 ...
	 */
	public String verifyResponse(Client client, cn.game.protocol.protobuf.RankMsg.RankListRequest_35000001 requestMessage, cn.game.protocol.protobuf.RankMsg.RankListResponse_35000002 responseMessage) {
