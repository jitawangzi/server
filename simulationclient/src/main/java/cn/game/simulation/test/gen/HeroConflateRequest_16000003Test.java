...
@Component
public class HeroConflateRequest_16000003Test extends ServerTest<cn.game.protocol.protobuf.HeroMsg.HeroConflateRequest_16000003, cn.game.protocol.protobuf.HeroMsg.HeroConflateResponse_16000004> {

	@Override
	public cn.game.protocol.protobuf.HeroMsg.HeroConflateRequest_16000003 buildDebugRequest(Client client) {
...
//		heroConflateInfo.setUid(Rnd.randomOne(herosList).getUid());
	...
	@Override
public cn.game.protocol.protobuf.HeroMsg.HeroConflateRequest_16000003 tryBuildSimulationRequest(Client client) {
		cn.game.protocol.protobuf.HeroMsg.HeroConflateRequest_16000003.Builder builder = cn.game.protocol.protobuf.HeroMsg.HeroConflateRequest_16000003.newBuilder() ; 
	 ...
	 */
	public String verifyResponse(Client client, cn.game.protocol.protobuf.HeroMsg.HeroConflateRequest_16000003 requestMessage, cn.game.protocol.protobuf.HeroMsg.HeroConflateResponse_16000004 responseMessage) {
	...
	public static void main(String args[]) throws Exception {
	    HeroConflateRequest_16000003Test instance = new HeroConflateRequest_16000003Test();
	    instance.start();
	}
