...
@Component
public class PlayerHeartbeatRequest_01000005Test extends ServerTest{
	...
	public static void main(String args[]) throws Exception{
		...
		ServerTestContext.send(client, () -> new PlayerHeartbeatRequest_01000005Test().getMessage(client));
