...
@Component
public class HCBattleSpeedAdsRequest_28000020Test extends ServerTest{
	...
	public static void main(String args[]) throws Exception{
		...
		ServerTestContext.send(client, () -> new HCBattleSpeedAdsRequest_28000020Test().getMessage(client));
