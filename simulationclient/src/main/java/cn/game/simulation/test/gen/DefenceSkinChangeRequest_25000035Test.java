...
@Component
public class DefenceSkinChangeRequest_25000035Test extends ServerTest<cn.game.protocol.protobuf.DevelopMsg.DefenceSkinChangeRequest_25000035, cn.game.protocol.protobuf.DevelopMsg.DefenceSkinChangeResponse_25000036> {

	@Override
	public cn.game.protocol.protobuf.DevelopMsg.DefenceSkinChangeRequest_25000035 buildDebugRequest(Client client) {
	...
	@Override
	public cn.game.protocol.protobuf.DevelopMsg.DefenceSkinChangeRequest_25000035 tryBuildSimulationRequest(Client client) {
		cn.game.protocol.protobuf.DevelopMsg.DefenceSkinChangeRequest_25000035.Builder builder = cn.game.protocol.protobuf.DevelopMsg.DefenceSkinChangeRequest_25000035.newBuilder() ; 
		List<DefenceSkinInfo> defenceSkinsList = client.getPlayerAllInfo().getDefenceSkinsList(); 
		DefenceSkinInfo randomElement = Rnd.randomElement(defenceSkinsList); 
		if (randomElement == null) {
	 ...
	 */
	public String verifyResponse(Client client, cn.game.protocol.protobuf.DevelopMsg.DefenceSkinChangeRequest_25000035 requestMessage, cn.game.protocol.protobuf.DevelopMsg.DefenceSkinChangeResponse_25000036 responseMessage) {
