...
import static cn.game.login.net.clientpacket.vertx.wechat.IOSPayOrderProcessor.tokenUrl;
...
public class WeiXinParamManager {
  ...
  public static WeiXinParamManager getInstance() {return Instance;}
